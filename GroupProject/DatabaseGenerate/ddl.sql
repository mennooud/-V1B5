...
CREATE TABLE Orderedproducts (orderedproductid SERIAL, Sessionssessionid varchar(255) NOT NULL, Productsproductid varchar(255), PRIMARY KEY (orderedproductid));
...
CREATE TABLE Recommendedproducts (recommendedproductid SERIAL, Profilesprofileid varchar(255) NOT NULL, Productsproductid varchar(255), PRIMARY KEY (recommendedproductid));
...
CREATE TABLE Viewedproducts (viewedproductid SERIAL, Profilesprofileid varchar(255) NOT NULL, Productsproductid varchar(255), PRIMARY KEY (viewedproductid));
